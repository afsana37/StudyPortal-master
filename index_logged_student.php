...
$level_term = $_SESSION['student_level_term'];
...
$welcome_greet = 	'
                			<div class="content_section">
									...
									<div><img src="uploads/student/'.$propic.'" alt="Image 01" class="image_wrapper image_fl" height="160px" width="135px" /> </div>
									<div style="margin-top:50px;"><p class="name"><a href="#profile">'.$student_name.'</a></p> </div>
									<p class="designation">Roll: '.$student_roll.'</p>
									<p class="designation">'.$level_term.'</p>
									<p class="dept">Department of '.$department.', MIST</p>
									<p class="email">Email: '.$student_email.'</p>
							</div>
						';
...
if (isset($_SESSION['student_name'])) {
	...
	<head>
		...
		<link href="css/student/tooplate_style.css" rel="stylesheet" type="text/css"/>
		<link href="css/student/color.css" rel="stylesheet" type="text/css"/>
		<link href="css/student/popup.css" rel="stylesheet" type="text/css"/>
		<link href="css/student/table.css" rel="stylesheet" type="text/css"/>


		<link rel="stylesheet" href="css/student/coda-slider.css" type="text/css" charset="utf-8"/>
		<link rel="stylesheet" href="css/student/tabs.css" type="text/css" charset="utf-8"/>
		...
		<script src="js/student/horizontal_tab.js"></script>
		<script src="js/student/horizontal_tab_sub.js"></script>
		<script src="js/student/table_view_st.js"></script>
	...
	<div id="slider">
				...
				<div class="scroll">
					<div class="scrollContainer">
						<div class="panel" id="home">
							...
							<script src="js/student/table_scroll.js"></script>
						...
						<div class="panel" id="profile">
							...
							<div class="last_section content_vio form_vio"  style="height:320px;margin:-50px 0 0 0px; ">
								...
								<form method="post" name="profile_student_form"
									  action="api/Student/profileStudent.php"
								...
								<div class="cleaner"></div>
									...
									<section>
										...
										<table class="table_course">
											...
											<tr id="table_course_firstrow"><th>Course-Code</th><th>Course-Title</th></tr>
											<?php


											$allcourse = $con->query("select * from course");
											if (mysqli_num_rows($allcourse) > 0) {
                                                while ($row = mysqli_fetch_array($allcourse, 1)) {
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $course_code_name.'-'.$course_code; ?></td>
		...
		<div class=" last_section content_red form_red" style="height:740px;">
			<h1 style="margin-bottom:-15px; margin-left:20px;">NOTICES</h1>
			<a href="#add_notice"><button class="button  add_button"  style="margin:-1200px 10px -50px 500px;">
					<span>Add </span></button> </a>
			<div class="cleaner"></div>
			<section>
				<div class="table_view table_red">
					<table cellpadding="0" cellspacing="0" border="0">
						<thead>
						<tr>
				...
				<div class="table_view_content table_red_content">
					<table cellpadding="0" cellspacing="0" border="0">
						<tbody>
						<?php
			...
			<div class="col_380 float_r"></div>
						...
						<div class="panel" id="discussion">
							<div class=" last_section content_yellow form_yellow" style="height:740px">
								...
								<form method="post"  name="add_student_discussion_form" action="api/student/add_post.php"
									  style="margin-left:100px">

									<label for="student_post">Write post...</label>
												<textarea id="student_post" name="student_post" rows="0" cols="0"
														  class="required"></textarea>
									<label for="student_post_corse">About Course...</label>
												<textarea id="student_post_course" name="student_post_course" rows="0" cols="0"
														  class="required"></textarea>
